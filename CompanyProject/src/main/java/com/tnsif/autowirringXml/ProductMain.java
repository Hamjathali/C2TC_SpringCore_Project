...
package com.tnsif.autowirringXml;
...
import com.tnsif.autowirringXml.Cart;
import com.tnsif.autowirringXml.Product;
...
public class ProductMain {
    ...
    private static double calculateTotal(Cart cart) {
        // Retrieve the list of products from the cart
